  ...
  return knex('Masses').del()
    ...
    .then(function () {
      ...
      return knex('Intentions').insert([
        ...
        { donor_id: 1, intention_text: "Messe pour les défunts", deceased: true, amount: 100, payment_method: 'cash', wants_celebration_date: true, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 2, intention_text: "Messe pour les malades", deceased: false, amount: 20, payment_method: 'cheque', wants_celebration_date: true, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 3, intention_text: "Messe pour les vivants", deceased: false, amount: 30, payment_method: 'transfer', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 4, intention_text: "Messe pour les défunts", deceased: true, amount: 25, payment_method: 'cash', wants_celebration_date: true, date_type: 'specifique', intention_type: 'unit' },
        { donor_id: 5, intention_text: "Messe pour les malades", deceased: false, amount: 45, payment_method: 'cheque', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 6, intention_text: "Messe pour les vivants", deceased: false, amount: 40, payment_method: 'transfer', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 1, intention_text: "Messe pour les défunts", deceased: true, amount: 25, payment_method: 'cash', wants_celebration_date: true, date_type: 'specifique', intention_type: 'unit' },
        { donor_id: 2, intention_text: "Messe pour les malades", deceased: false, amount: 45, payment_method: 'cheque', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 3, intention_text: "Messe pour les vivants", deceased: false, amount: 40, payment_method: 'transfer', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 4, intention_text: "Messe pour les défunts", deceased: true, amount: 25, payment_method: 'cash', wants_celebration_date: true, date_type: 'specifique', intention_type: 'unit' },
        { donor_id: 5, intention_text: "Messe pour les malades", deceased: false, amount: 45, payment_method: 'cheque', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 6, intention_text: "Messe pour les vivants", deceased: false, amount: 40, payment_method: 'transfer', wants_celebration_date: false, date_type: 'indifferente', intention_type: 'unit' },
        { donor_id: 1, intention_text: "Messe pour les défunts", deceased: true, amount: 25, payment_method: 'cash', wants_celebration_date: true, date_type: 'specifique', intention_type: 'unit' },
