	...
	return knex("Masses")
		...
		.then(function () {
			...
			return knex("Masses").insert([
				// { date: "2025-03-28", celebrant_id: 1, intention_id: 1, status: "pending" },
				// { date: "2025-04-30", celebrant_id: 2, intention_id: 2, status: "scheduled" },
				...
				// { date: "2025-06-15", celebrant_id: 5, intention_id: 5, status: "scheduled" },
				// { date: "2025-06-15", celebrant_id: 8, intention_id: 8, status: "scheduled" },
				// { date: "2025-06-15", celebrant_id: 11, intention_id: 11, status: "scheduled" },
				// { date: "2025-06-15", celebrant_id: 14, intention_id: 14, status: "scheduled" },
				// { date: "2025-06-15", celebrant_id: 17, intention_id: 17, status: "scheduled" },
				// { date: "2025-06-15", celebrant_id: 20, intention_id: 20, status: "scheduled" },
