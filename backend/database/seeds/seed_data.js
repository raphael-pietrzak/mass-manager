...
exports.seed = function (knex) {
	...
	return (
		knex("Masses")
			...
			// 		{ date: "2025-08-20", celebrant_id: 1, intention_id: 6, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 2, intention_id: 6, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 3, intention_id: 6, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 4, intention_id: 6, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 5, intention_id: 6, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 6, intention_id: 6, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 7, intention_id: 7, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 8, intention_id: 8, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 9, intention_id: 9, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 10, intention_id: 10, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 11, intention_id: 11, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 12, intention_id: 12, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 13, intention_id: 13, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 14, intention_id: 14, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 15, intention_id: 15, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 16, intention_id: 16, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 17, intention_id: 17, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 18, intention_id: 18, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 19, intention_id: 19, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 20, intention_id: 20, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 21, intention_id: 21, status: "scheduled" },
			//     { date: "2025-08-20", celebrant_id: 22, intention_id: 22, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 23, intention_id: 23, status: "scheduled" },
			// 		{ date: "2025-08-20", celebrant_id: 1, intention_id: 29, status: "scheduled" },
			// 	])
			// })
			// .then(function () {
			...
			.then(function () {
				return knex("Users").insert([
					{ login_name: "admin", password: bcrypt.hashSync("admin", 10), email: "admin@lagrasse.org", role: "admin" },
