  ...
  return knex('Masses').del()
    ...
    .then(function () {
      return knex('Masses').insert([
        { date: '2025-03-28', celebrant_id: 1, intention: "Messe pour les défunts", donor_id: 1, status: 'scheduled', deceased: true, amount: 100, wants_notification: true },
        { date: '2025-04-30', celebrant_id: 2, intention: "Messe pour les malades", donor_id: 2, status: 'pending', deceased: false, amount: 20, wants_notification: true },
        { date: '2025-05-01', celebrant_id: 3, intention: "Messe pour les vivants", donor_id: 3, status: 'scheduled', deceased: false, amount: 30, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 4, intention: "Messe pour les défunts", donor_id: 4, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 5, intention: "Messe pour les malades", donor_id: 5, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
        { date: '2025-07-20', celebrant_id: 6, intention: "Messe pour les vivants", donor_id: 6, status: 'cancelled',  deceased: false, amount: 40, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 7, intention: "Messe pour les défunts", donor_id: 7, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 8, intention: "Messe pour les malades", donor_id: 1, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
        { date: '2025-07-20', celebrant_id: 9, intention: "Messe pour les vivants", donor_id: 2, status: 'cancelled',  deceased: false, amount: 40, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 10, intention: "Messe pour les défunts", donor_id: 3, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 11, intention: "Messe pour les malades", donor_id: 4, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
        { date: '2025-07-20', celebrant_id: 12, intention: "Messe pour les vivants", donor_id: 5, status: 'cancelled',  deceased: false, amount: 40, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 13, intention: "Messe pour les défunts", donor_id: 6, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 14, intention: "Messe pour les malades", donor_id: 7, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
        { date: '2025-07-20', celebrant_id: 15, intention: "Messe pour les vivants", donor_id: 1, status: 'cancelled',  deceased: false, amount: 40, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 16, intention: "Messe pour les défunts", donor_id: 2, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 17, intention: "Messe pour les malades", donor_id: 3, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
        { date: '2025-07-20', celebrant_id: 18, intention: "Messe pour les vivants", donor_id: 4, status: 'cancelled',  deceased: false, amount: 40, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 19, intention: "Messe pour les défunts", donor_id: 5, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 20, intention: "Messe pour les malades", donor_id: 6, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
        { date: '2025-07-20', celebrant_id: 21, intention: "Messe pour les vivants", donor_id: 7, status: 'cancelled',  deceased: false, amount: 40, wants_notification: false },
        { date: '2025-05-02', celebrant_id: 22, intention: "Messe pour les défunts", donor_id: 1, status: 'scheduled',  deceased: true, amount: 25, wants_notification: true },
        { date: '2025-06-15', celebrant_id: 23, intention: "Messe pour les malades", donor_id: 2, status: 'pending',  deceased: false, amount: 45, wants_notification: false },
      ]);
    })
    .then(function () {
